  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="flex flex-row items-center justify-center gap-2 mt-48 mb-2 ml-0 mr-0">
        ...
        <button  className="p-4 flex flex-row items-center disabled:opacity-75 text-white bg-gray-700 hover:bg-gray-600 rounded-md overflow-hidden"
          onClick={() => dispatch(addWord())}
        >
          <BiPlus className="pointer-events-none"/>Add Word
        </button>
        <button  className="p-4 flex flex-row items-center disabled:opacity-75 text-white bg-gray-700 hover:bg-gray-600 rounded-md overflow-hidden"
